...
parser.add_argument('--dataset', '-d', type=str, default='OTB100',  # OTB100 VOT2019
                    help='dataset name')
parser.add_argument('--num', '-n', default=1, type=int,
                    help='number of thread to eval')
parser.add_argument('--tracker_prefix', '-t', default='augtrack',
...
def main():
    ...
    root = os.path.realpath(os.path.join(os.path.dirname(__file__), '../data'))
