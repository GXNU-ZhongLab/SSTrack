...
class OTBDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        ...
        # ---------- edit sequence: Jogging-1, Jogging-2, Skating2-1 ----------
        meta_data['Jogging-1']['video_dir'] = 'Jogging'
        meta_data['Jogging-1']['img_names'] = [path.replace('Jogging-1', 'Jogging') for path in meta_data['Jogging-1']['img_names']]
        meta_data['Jogging-2']['video_dir'] = 'Jogging'
        meta_data['Jogging-2']['img_names'] = [path.replace('Jogging-2', 'Jogging') for path in meta_data['Jogging-2']['img_names']]
        meta_data['Skating2-1']['video_dir'] = 'Skating2'
        meta_data['Skating2-1']['img_names'] = [path.replace('Skating2-1', 'Skating2') for path in meta_data['Skating2-1']['img_names']]
        meta_data['Skating2-2']['video_dir'] = 'Skating2'
        meta_data['Skating2-2']['img_names'] = [path.replace('Skating2-2', 'Skating2') for path in meta_data['Skating2-2']['img_names']]
        # ---------- edit sequence: Jogging-1 and Jogging-2 ----------
