...
cfg.MODEL.BACKBONE.TEMPLATE_BOX_MASK = 'ALL'  # choose between ALL, CTR_POINT, CTR_REC, GT_BOX
...
cfg.TRAIN.AMP = False
cfg.TRAIN.CONTRASTIVE_LOSS = False
...
cfg.DATA.GROUNDING.FACTOR = 5.0
cfg.DATA.GROUNDING.CENTER_JITTER = 0
cfg.DATA.GROUNDING.SCALE_JITTER = 0
