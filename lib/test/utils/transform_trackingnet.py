...
if __name__ == "__main__":
    ...
    parser.add_argument('--tracker_name', type=str, default='augtrack', help='Name of tracking method.')
    parser.add_argument('--cfg_name', type=str, default='dropmae_got_s1_scale1_cp_150ep_multiframe_150', help='Name of config file.')
