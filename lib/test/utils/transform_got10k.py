...
if __name__ == "__main__":
    ...
    parser.add_argument('--tracker_name', type=str, default='mmtrack', help='Name of tracking method.')
    parser.add_argument('--cfg_name', type=str, default='mtms_got_085', help='Name of config file.')
