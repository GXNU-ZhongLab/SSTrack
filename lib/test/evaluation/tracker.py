...
class Tracker:
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        multimodal_datasets = ['lasher', 'rgbt234', 'rgbt210',  # RGBT datasets
        ...
        if False:
            ...
            img = cv.imread(seq.frames[0])  # multimodal: seq.frames[0][0]
            # show_frame(img, np.array(init_info["init_bbox"]))
            
            save_path = '/home/data/yz/2025NIPS/UnTrack/debug/video'
