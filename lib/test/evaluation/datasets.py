...
dataset_dict = dict(
    ...
    yt2018_test=DatasetInfo(module=seg % "youtubevos", class_name="YouTubeVOS", kwargs=dict(version='2018', split='test')),
    yt2019_valid=DatasetInfo(module=seg % "youtubevos", class_name="YouTubeVOS", kwargs=dict(version='2019', split='valid')),
    yt2018_valid=DatasetInfo(module=seg % "youtubevos", class_name="YouTubeVOS", kwargs=dict(version='2018', split='valid')),
    ...
    # Depth Datasets
    depthtrack=DatasetInfo(module=pt % "depthtrack", class_name="DepthTrackDataset", kwargs=dict(split='test', dtype='rgbcolormap')),
    arkit=DatasetInfo(module=pt % "arkit", class_name="ARKitDataset", kwargs=dict()),
