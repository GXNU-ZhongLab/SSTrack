...
class CenterPredictor(nn.Module, ):
    ...
    def forward(self, x, gt_score_map=None, track_query=None):
...
def build_seg_decoder(cfg, hidden_dim):
    stride = cfg.MODEL.BACKBONE.STRIDE
    in_channel = hidden_dim
    out_channel = cfg.MODEL.HEAD.NUM_CHANNELS
    feat_sz = int(cfg.DATA.SEARCH.SIZE / stride)
    return Seg_Decoder(inplanes=in_channel, channel=out_channel, feat_sz=feat_sz, stride=stride)